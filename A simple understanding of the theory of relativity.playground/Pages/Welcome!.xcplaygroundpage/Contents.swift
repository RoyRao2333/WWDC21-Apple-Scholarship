...
Back when I was in high school, my physics teacher was a big fan of _Albert Einstein_ and he would always talk about him whenever he got the chance. So what does __the heory of relativity__ have to do with this great man? Just hear me out!
...
__Theory of relativity__ is a theory of space-time and gravity, mainly proposed by _Albert Einstein_. It can be divided into __special relativity__ and __general relativity__, depending on the subjects studied.  Einstein's theory of relativity greatly changed the law of motion and later replaced __Newton's law of universal gravitation__. It promoted leaps and bounds in physics, and it was also a huge leap for humankind.
 
&nbsp;
 
- Note: __The theory of relativity__ is Einstein's amendment to the __Newtonian mechanics system__, not a substitute. That is to say, Newton’s mechanics is not wrong, but its scope of application is limited. It can only be used under low-speed macroscopic conditions, and Newton’s mechanics is not accurate when the object is moving close to the speed of light. Then we have to use relativistic mechanics to correct it. So we can say that Newtonian mechanics is a special case of relativistic mechanics when the speed is much lower than the speed of light.
 
![DIVIDER](Preface_Assets/divider.png)

- callout(Special relativity?):
__The special theory of relativity__ is a new straight spacetime theory that is different from Newton's view of spacetime and proposed in the article _On the Electrodynamics of Moving Bodies_ published by Einstein in 1905. __Special__ means that it only applies to inertial reference systems. The starting point of this theory is two basic postulates: __The principle of special relativity__ and __the principle of constant speed of light__. The core equation of the theory is the Lorentz transformation. Special relativity predicts some new effects that Newtonian classical physics does not have, such as __Length Contraction__, __Time Dilation__, and __Relativistic Doppler effect__. Special relativity has become one of the foundations of modern physics theories. All microscopic physical theories (such as elementary particle theory) and macroscopic gravitational theories (such as general relativity) meet the requirements of special relativity. These relativistic dynamics theories have been confirmed by many high-precision experiments.
...
Einstein gave the initial form of __the general theory of relativity__ in a series of papers published around 1915. He first noticed the experimental fact called __the equivalence principle__: the gravitational mass is equal to the inertial mass. This fact can also be understood that when there is no force other than gravity, all test objects with sufficiently small mass (that is, the influence of their own mass on the gravitational field can be ignored) move in the same gravitational field in the same way. It was in this way of thinking that Einstein got his general theory of relativity.
 
&nbsp;
 
Systematically, __the general theory of relativity__ includes the following basic postulates:
...
*/
/*:
__The theory of relativity__ is mainly useful in two aspects: one is __high-speed motion__ (which is comparable to the speed of light), and the other is __strong gravitational field__. \
For example:
- In the radiotherapy department of hospitals, most of them are equipped with a __particle accelerator__, which produces high-energy particles to produce isotopes for treatment or imaging.
- __The atomic clock__ on the satellite of the Global Positioning system (GPS) is very important for accurate positioning. The algorithm of GPS is based on the principle of constant speed of light. If the principle of constant speed of light does not hold, then the GPS will need to replace a different algorithm to locate accurately.
